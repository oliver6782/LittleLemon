...
from .serializers import CategorySerializer, MenuItemSerializer,ManagerSerializer,CartHelpSerializer,CartSerializer,CartAddSerializer,CartRemoveSerializer,OrderSerializer,OrderPutSerializer,UserSerializer,SingleHelperSerializer,SingleOrderSerializer
...
class MenuItemDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        return JsonResponse(
            status=200,
            data={
                'message': 'Featured status of {} changed to {}'.format(menuitem.title, menuitem.featured)
            }
        )
